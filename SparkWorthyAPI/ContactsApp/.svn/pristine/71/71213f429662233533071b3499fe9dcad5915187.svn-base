...
namespace ContactAppAPI.Models.Login
{
    public class RegisterModules
    {
        ...
        {
            SqlCommand sqlcommand = new SqlCommand("usp_insert_user_interest_list");
            sqlcommand.CommandType = CommandType.StoredProcedure;
        ...
        /// <returns></returns>
        protected internal DataTable ValidateEmail(string Email)
        {
            SqlCommand sqlCommand = new SqlCommand("usp_validate_email");
            sqlCommand.CommandType = CommandType.StoredProcedure;
            sqlCommand.Parameters.AddWithValue("@Email", Email.ToString().Trim());
