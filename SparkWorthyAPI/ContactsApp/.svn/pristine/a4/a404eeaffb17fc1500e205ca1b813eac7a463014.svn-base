                ...
                if (dtGetUsers.Rows.Count > 0)
                {
                    foreach (DataRow dr in dtGetUsers.Rows)
                    {
                        ...
                        if (!string.IsNullOrEmpty(Convert.ToString(dr[14])))
                            groupContactTypes.ContactProfilePicture = ConfigurationManager.AppSettings["ContactProfile"].ToString().Trim() + Convert.ToString(dr[14]);
                        ...
                        if (!string.IsNullOrEmpty(Convert.ToString(dr[21])))
                            groupContactTypes.GroupProfilePicture = ConfigurationManager.AppSettings["GroupProfile"].ToString().Trim() + Convert.ToString(dr[21]);
            ...
            if (!string.IsNullOrEmpty(Convert.ToString(UserId)) && (UserId != 0))
            {
                ...
                if (dtContactList.Rows.Count > 0)
                {
                    foreach (DataRow dr in dtContactList.Rows)
                    {
                        ...
                        if (!string.IsNullOrEmpty(Convert.ToString(dr[2])))
                            groupModelsTypes.GroupProfilePicture = ConfigurationManager.AppSettings["GroupProfile"].ToString().Trim() + Convert.ToString(dr[2]);
