...
namespace ContactAppAPI.Models
{
    public class ContactModels
    {
        ...
        public string SaveContact()
        {
            ...
            sqlcommand.Parameters.AddWithValue("@RelativeORFamily", this.RelationShip.ToString().Trim());
            ...
            sqlcommand.Parameters.AddWithValue("@AnnivesaryOn", this.Annivasary.ToString().Trim());
        ...
        {
            SqlCommand sqlCommand = new SqlCommand("usp_upload_profile_picture");
            sqlCommand.CommandType = CommandType.StoredProcedure;
            sqlCommand.Parameters.AddWithValue("@TypeId", this.TypeId.ToString().Trim());
            sqlCommand.Parameters.AddWithValue("@Id", this.ContactId.ToString().Trim());
            sqlCommand.Parameters.AddWithValue("@ProfilePicture", this.ProfilePicture.ToString().Trim());
            DBOperations dbOeration = new DBOperations();
            string outputValue = string.Empty;
            bool Status = dbOeration.SaveData(sqlCommand, out outputValue, "");
            if (Status)
                return this.ProfileLocation.ToString().Trim();
            else
                return "false";
        }
        ...
        public string UpdateCircle()
        {
            ...
            sqlcommand.CommandType = CommandType.StoredProcedure;
            sqlcommand.Parameters.AddWithValue("@ContactId", this.ContactId.ToString().Trim());
            sqlcommand.Parameters.AddWithValue("@Relation", this.RelationShip.ToString().Trim());
            sqlcommand.Parameters.AddWithValue("@Profession", this.Profession.ToString().Trim());
        ...
        public bool SynchContactInfo(string EmailId, int UserId)
        {
            SqlCommand sqlCommand = new SqlCommand("usp_sparkworthy_synch_contacts_info");
            sqlCommand.CommandType = CommandType.StoredProcedure;
            sqlCommand.Parameters.AddWithValue("@LogEmailId", EmailId.ToString().Trim());
            sqlCommand.Parameters.AddWithValue("@logId", UserId.ToString().Trim());
            DBOperations dbOeration = new DBOperations();
            string outputValue = string.Empty;
            bool Status = dbOeration.SynchContacts(sqlCommand);
            if (Status)
                return true;
            else
                return false;
